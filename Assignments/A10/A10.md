# Bio5488 SP2026: Assignment 10

### Proteogenomics

**Due Date:** Friday, 4/3, 11:59 PM   (Start early, some programs may take hours to run)
...
3. Agree to licensing terms and download release 4.3.2 of Crux
4. Unzip the download
5. The program we will be running from the command line is in the bin/ folder
...
1. Save the reference proteome to your project folder (/storage1/fs1/workshops/Active/BIO5488/SP2026.L41.BIOL.5488.01/Assignments/A10/Users/<user name> )
