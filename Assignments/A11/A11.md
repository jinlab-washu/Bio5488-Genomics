...
2. A readme file that contains the command to execture the script & the output of your file. Copy and paste the standard output from the terminal into your readme file or run your file and redirect the output to a file. 
For example:
   ```
