...
# Find unique markers for each cell cluster and select two unique marker genes for each cluster, then plot the expression of the selected marker genes for all clusters using violin plot.
...
# Jimmy (SP2025 TA) cannot get this to install, so we are finding the conserved markers in the old way.
